...
function loadDashboard() {
    getJobStats(function (data) {
        $(".queued", ".stats-container").text(data.JobsQueued);
        $(".processing", ".stats-container").text(data.JobsProcessing);
        $(".completed", ".stats-container").text(data.JobsCompleted);
        $(".failed", ".stats-container").text(data.JobsFailed);
    });
}
